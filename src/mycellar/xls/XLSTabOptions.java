...
public final class XLSTabOptions extends JDialog {
  ...
  public XLSTabOptions() {
    ...
    tv.addString(Program.getLabel("Infos132"), Program.getCaveConfigBool(XLSTAB_COL0, true));
    tv.addString(Program.getLabel("Infos189"), Program.getCaveConfigBool(XLSTAB_COL1, false));
    tv.addString(Program.getLabel("Infos134"), Program.getCaveConfigBool(XLSTAB_COL2, false));
